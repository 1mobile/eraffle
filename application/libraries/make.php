...
class Make{
    ...
    //////////////////////////////////////////////////////////
		...
		function listTable($thead=array(),$rows=array(),$params=array()){
			$str = "";

			$str .= $this->sTag('div',array('class'=>'table-responsive','style'=>'margin-top:10px;'));
				$params = $this->classitize($params,"table table-striped");
				$str .= $this->sTag('table',$params);
					$str .= $this->sTag('thead');
						$str .= $this->sTag('tr');
							foreach ($thead as $text => $opts) {
	...
	/////	MAKE EXCEL 			   ////////////////////////////
    //////////////////////////////////////////////////////////
		function excer($rows=array(),$results=array(),$params=array()){
			$str = "";
			$params = $this->classitize($params,"excer");
			$str .= $this->eTag('table',$params);
				$str .= $this->sTag('thead');
    ...
    //////////////////////////////////////////////////////////
		function StatusDrop($label=null,$nameID=null,$value=null,$placeholder=null,$params=array()){
	    	$CI =& get_instance();
	    ...
	    function themeDrop($label=null,$nameID=null,$value=null,$placeholder=null,$params=array()){
	    	$CI =& get_instance();
	 		$CI->load->model('site/site_model');
	    	$str = "";
				$selectParams = $params;
	    ...
	    function attrTypesDrop($label=null,$nameID=null,$value=null,$placeholder=null,$params=array()){
	    	$CI =& get_instance();
	 		$CI->load->model('site/site_model');
	    	$str = "";
				$selectParams = $params;
	    ...
	    function itemsDrop($label=null,$nameID=null,$value=null,$placeholder=null,$params=array()){
	    	...
	    	$str = "";
				...
				$results=$CI->site_model->get_custom_val('items',array('item_name, item_id, item_code, uom'),'inactive',0,true);

				$opts  = array();
				if($placeholder != null)
					$opts[$placeholder] = '';
				foreach ($results as $res) {
					$opts["[ ".$res->item_code." ] ".$res->item_name] = array('value'=>$res->item_id,'uom'=>$res->uom);
				}
				$str .= $this->select($label,$nameID,$opts,$value,$selectParams);
			if($this->returnitize($params)) return $str; else $this->code .= $str;
	    }
